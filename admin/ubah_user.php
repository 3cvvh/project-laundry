        ...
        <div class="w-full max-w-md bg-white rounded-lg shadow p-8 mt-10">
            ...
            <form action="proses_ubah_user.php" method="post" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="password" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm" placeholder="masukan password baruu" required>
                </div>
                <div>
